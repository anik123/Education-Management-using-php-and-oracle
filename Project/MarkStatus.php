...
<script type="text/javascript">
	...
	function status()
	{
		...
		http.open("POST","GetMark.php",false);
	...
	<section id="main" class="column">
        ...
        <fieldset>
                           ...
                           <?php
							...
							$query1=oci_parse($conn,"select e.CourseCode CourseCode,e.CourseName CourseName from course e,assignteacher a where e.CourseCode=a.CourseCode and a.VersityId='".$_SESSION["user"]."'");
							oci_execute($query1);
