   ...
   echo "<h3>Notice</h3>
	...
	<section id="main" class="column">
		...
		<article class="module width_half" >
			...
			<form id="form1" method="post" enctype="multipart/form-data" action="upload.php">
            <header><h3>Upload Matarial</h3></header>
				
                <div class="module_content">
               <fieldset>
							<label>Course</label>
							<select  name="course" style="width:92%;">
                   ...
                   <fieldset>
							...
							<select  name="uploadtype" style="width:92%;">
                        ...
                        <fieldset>
							...
							<input name="upload" type="file" id="ts" style="width:92%;" />
						</fieldset>
			...
			<footer>
				<div class="submit_link">
					...
					<input type="submit" onClick="check();" value="Upload" class="alt_btn" />
