...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_3_quarter">
			...
			<form id="form1" enctype="multipart/form-data" method="post" action="SubmitProblem.php"> 
            <header><h3>Create Problem</h3></header>
                ...
                <div class="module_content">
						 ...
						 <fieldset>
                            ...
                            <?php
							$cate=mysql_query("select * from category") or die(mysql_error());
