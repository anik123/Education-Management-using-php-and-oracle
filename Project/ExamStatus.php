...
<script type="text/javascript">
	...
	function status()
	{
		...
		http.open("POST","GetHeader.php",false);
	    http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		http.send("course="+v2+"&exam="+v1);
	   ...
	   if($query["ROLE"]=="Teacher")
{
	...
	<section id="main" class="column">
        ...
        <fieldset>
							...
							<select  id="exam" onChange="status();" style="width:92%;">
                            <option value="0">Select Exam Duration</option>
                            <option value="past">Past Exam</option>
                            <option value="future">Upcoming Exam</option>
                            </select>
         </fieldset>
         </form>
         </td>
