	...
	<section id="main" class="column">
		...
		<article class="module width_3_quarter">
            ...
            <h3>Course Details</h3>
                ...
                <?php
				$data=oci_parse($conn,"select * from course where CourseId=$CourseId");
				oci_execute($data);
...
<tr>
<td style="width:25%;"><div style="text-align:right;font-size:18px;">
<label>Course Code : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label><?php echo $row["COURSECODE"]; ?></label></div>
</td>
</tr>
<tr>
...
<td><div style="text-align:center;font-size:16px;">
<label><?php echo $row["COURSENAME"]; ?></label></div>
</td></tr>
<tr>
<td><div style="text-align:right;font-size:18px;">
<label>Max Student : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label><?php echo $row["MAXSTUDENT"]; ?></label></div>
</td></tr>
<tr>
<td><div style="text-align:right;font-size:18px;">
<label>Course Teacher : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label><?php 

$data1=oci_parse($conn,"select * from assignteacher where CourseCode='".$row["COURSECODE"]."'");
oci_execute($data1);
$data1=oci_fetch_array($data1,OCI_ASSOC+OCI_RETURN_NULLS);
echo $data1["VERSITYID"];

?></label></div>
</td></tr>
<tr>
<td><div style="text-align:right;font-size:18px;">
<label>Total Student : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label>
<?php 

$data1=oci_parse($conn,"select count(*) as g from assignstudent where CourseCode='".$row["COURSECODE"]."'");
oci_execute($data1);
$data1=oci_fetch_array($data1,OCI_ASSOC+OCI_RETURN_NULLS);
echo $data1["G"];
...
<tr>
<td><div style="text-align:right;font-size:18px;">
<label>Course Status : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label><?php echo $row["COURSESTATUS"]; ?></label></div>
</td></tr>
<tr>
<td><div style="text-align:right;font-size:18px;">
<label>Course Description : </label></div>
</td>
<td><div style="text-align:center;font-size:16px;">
<label><?php echo $row["DESCRIPTION"]; ?></label></div>
</td>
</tr>
</table>
				</div>
