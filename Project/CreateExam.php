...
function check()
{
	...
	http.open("POST","SubmitExam.php",false);
	http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	http.send("course="+course+"&examtype="+examtype+"&datepicker="+datepicker+"&mark="+mark+"&duration="+duration+"&tq="+tq);
            ...
            <header><h3>Create Exam</h3></header>
                ...
                <div class="module_content">
						 ...
						 <fieldset>
                            ...
                            <?php
							$query=oci_parse($conn,"select e.CourseCode CourseCode,e.CourseName from course e,assignteacher a where e.CourseCode=a.CourseCode and a.VersityId='".$_SESSION["user"]."'");
							oci_execute($query);
                        ...
                        <fieldset>
							...
							<select  id="examtype" style="width:92%;">
                            <option value="0">Select Exam Type</option>
                            <option value="1st Quiz">1st Quiz</option>
                            <option value="2nd Quiz">2nd Quiz</option>
                            <option value="3rd Quiz">3rd Quiz</option>
                            <option value="1st Mid">1st Mid</option>
                            <option value="2nd Mid">Final Exam</option>
                            
                            </select>
						</fieldset>
						<fieldset>
							<label>Exam Date</label>
							<input type="text" style="width:92%;"  id="datepicker" name="dob" />
						</fieldset>
                        
                        <fieldset>
							<label>Exam Marks</label>
							<input type="text" style="width:92%;" id="mark"/>
						</fieldset>
						<fieldset>
							<label>Exam Duration</label>
                            
							<input type="text"  style="width:92%;"  id="duration" value="HH:MM:SS" onMouseDown="this.value='';" onMouseUp="this.value='';"/>                           
						</fieldset>
                        <fieldset>
							<label>Total Questions</label>
                            
							<input type="text"  style="width:92%;" id="tq" />                           
						</fieldset>
						<div class="clear"></div>
				</div>
			<footer>
