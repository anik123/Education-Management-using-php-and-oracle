...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_3_quarter">
			...
			<form id="form1" enctype="multipart/form-data" method="post" action="SubmitContestProblem.php"> 
            <header><h3>Create Category</h3></header>
                ...
                <div class="module_content">
						 ...
						 <fieldset>
                            ...
                            <option value="0">Select Contest Name</option>
                            <?php
							$cate=mysql_query("select * from contest where CreatedBy='".$_SESSION["user"]."'") or die(mysql_error());
							while($row=mysql_fetch_array($cate))
							   echo "<option value='".$row["ContestId"]."'>".$row["ContestName"]."</option>"; 
							?>
                            </select>
			             </fieldset>
                        <fieldset>
							<label>Problem Name</label>
                         <input name="pname" type="text" style="width:92%;"/>
                         </fieldset>
                         <fieldset>
							<label>Description</label>
                           <textarea name="desc" style="width:92%; height:200px;resize:none;">
                           </textarea>
                         </fieldset>
                         <fieldset>
							<label>Input Description</label>
                           <textarea name="pdesc" style="width:92%; height:200px;resize:none;">
                           </textarea>
                         </fieldset>
                         <fieldset>
							<label>Output Description</label>
                           <textarea name="odesc" style="width:92%; height:200px;resize:none;">
                           </textarea>
                         </fieldset>
                         <fieldset>
							<label>Sample Input</label>
                           <textarea name="sami" style="width:92%; height:200px;resize:none;">
                           </textarea>
                         </fieldset><fieldset>
							<label>Sample Output</label>
                           <textarea name="samo" style="width:92%; height:200px;resize:none;">
                           </textarea>
                         </fieldset>
                         <fieldset>
							<label>Input Case</label>
                           <input name="icase" type="file" style="width:92%;"/>
                         </fieldset>
                          <fieldset>
							<label>Output Case</label>
                           <input name="ocase" type="file" style="width:92%;"/>
                         </fieldset>
						<div class="clear"></div>
				</div>
			<footer>
