...
<pre>				
<strong>Course Code   : </strong>".$row["ContestName"]."
<strong>Course Name   : </strong>".$row["ContestDate"]."
<strong>Exam Type     : </strong>".$row["ContestTime"]."
<strong>Exam Mark     : </strong>".$row["ContestDuration"]."
<strong>Exam Duration : </strong>".$row["TotalProblem"]."
