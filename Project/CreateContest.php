...
function check()
{
	...
	http.open("POST","SubmitContest.php",false);
	http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	http.send("cname="+cname+"&datepicker="+datepicker+"&ctime="+ctime+"&duration="+duration+"&tq="+tq);
...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_half">
            ...
            <header><h3>Create Contest</h3></header>
                ...
                <div class="module_content">
						...
						<fieldset>
							...
							<input type="text"  style="width:92%;"  id="ctime" value="HH:MM:SS" onMouseDown="this.value='';"/>                           
						</fieldset>
						<fieldset>
							<label>Contest Duration</label>
                            
							<input type="text"  style="width:92%;"  id="duration" value="HH:MM:SS" onMouseDown="this.value='';"/>                           
						</fieldset>
                        <fieldset>
							<label>Total Problem</label>
