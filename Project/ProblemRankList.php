	...
	<section id="main" class="column">
		...
		<article class="module width_3_quarter">
			...
			<div id="tab1" class="tab_content">
             ...
             <?php
			$i=1;
				$value=mysql_query("select u.FirstName FirstName,u.LastName LastName,u.UserId UserId,cr.Tried Tried ,cr.Accepted Accepted  from user u,Problemrank cr where u.VersityId=cr.VersityId order by cr.Accepted desc");
