...
function check()
{
    ...
    http.open("GET","Assign_TCheck.php?course="+course+"&teacher="+teacher,false);
	http.send();
		...
		<article class="module width_half" >
            ...
            <header><h3>Assign Course</h3></header>
                ...
                <div class="module_content">
                        ...
                        <fieldset>
							<label>Teacher</label>
							<select id="teacher" style="width:92%;">
                            <option value="0">Select Teacher</option>
                            <?php
							$query=oci_parse($conn,"select * from userinfo where role='Teacher'");
							oci_execute($query);
