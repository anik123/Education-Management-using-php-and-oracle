...
function check()
{
	...
	http.open("POST","SubmitUser.php",false);
	http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	http.send("vid="+vid+"&pass="+pass+"&datepicker="+datepicker+"&fname="+fname+"&lname="+lname+"&email="+email+"&pn="+pn+"&role="+role+"&us="+us);
            ...
            <header><h3>Create User</h3></header>
                ...
                <div class="module_content">
						 ...
						 <fieldset>
							...
							<input type="text" style="width:92%;" id="vid" />
						</fieldset>
						<fieldset>
							<label>Password</label>
                            <input type="text"  style="width:92%;"  id="pass" />
						</fieldset>
                        
                        <fieldset>
							<label>First Name</label>
							<input type="text" style="width:92%;" id="fname"/>
						</fieldset>
						<fieldset>
							<label>Last Name</label>
                            
							<input type="text"  style="width:92%;"  id="lname" />                           
						</fieldset>
                        <fieldset>
							<label>Date Of Birth</label>
                           <input type="text" style="width:92%;"  id="datepicker"  />               
						</fieldset>
                        <fieldset>
							<label>Email</label>
                            
							<input type="text"  style="width:92%;" id="email" />                           
						</fieldset>
                        <fieldset>
							<label>Phone Number</label>
                            
							<input type="text"  style="width:92%;" id="pn" />                           
						</fieldset>
                        <fieldset>
							<label>ROLE</label>
