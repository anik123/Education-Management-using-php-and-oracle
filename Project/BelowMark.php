...
<script type="text/javascript">
	...
	{
		//alert("hi");
		var v1=document.getElementById("mark").value;
		var v2=document.getElementById("course").value;
		
		var http=new XMLHttpRequest();
		http.open("POST","GetBelowMark.php",false);
	    http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		http.send("course="+v2+"&mark="+v1);
	...
	<section id="main" class="column">
        ...
        <fieldset>
         ...
         <td>
							...
							<div>
							<input type="submit" style="width:92%" onClick="status();" Value="Search" />
         </div>
         </form>
         </td>
