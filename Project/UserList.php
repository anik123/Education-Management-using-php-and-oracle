	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
   					<th><center>#</center></th> 
    				<th><center>Versity Id</center></th> 
			...
			$data=oci_parse($conn,"select * from userinfo") or die(oci_error());
				oci_execute($data);
			while($row=oci_fetch_array($data,OCI_ASSOC+OCI_RETURN_NULLS))
					{
						echo "<tr><td><center><a href='UpdateUser.php?UserId=".$row["USERID"]."'>Edit</a></center></td>"; 
						...
						echo "<td><center>".$row["ACTIVITY"]."</center></td></tr>";
