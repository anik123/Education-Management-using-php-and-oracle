...
<script type="text/javascript">
	...
	function status()
	{
		...
		http.open("POST","GetMyMark.php",false);
	...
	<section id="main" class="column">
        ...
        <fieldset>
                           ...
                           <?php
							...
							$query1=oci_parse($conn,"select e.CourseCode CourseCode,e.CourseName from course e,assignstudent a where e.CourseCode=a.CourseCode and a.VersityId='".$_SESSION["user"]."'");
							oci_execute($query1);
