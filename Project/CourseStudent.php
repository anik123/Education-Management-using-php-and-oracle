...
<script type="text/javascript">
	...
	function status()
	{
		...
		http.open("POST","GetCourseStudent.php",false);
   ...
   echo "<h3>Notice</h3>
	...
	<section id="main" class="column">
        ...
        <fieldset>
                           ...
                           <?php
							$query=mysql_query("select c.CourseCode CourseCode , c.CourseName CourseName from Course c,assignteacher a where c.CourseCode=a.CourseCode and a.VersityId='".$_SESSION["user"]."'");
